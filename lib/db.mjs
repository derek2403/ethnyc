...
export function saveVerifiedSkill({ skill, files, agentId, auditId, fileSha256, extra = {} }) {
  ...
  entry.versions.push({
    ...
    verified_at: now(),
    ...extra, // optional premium-skill fields (author, royalty, license token, …)
  });
  reg[base] = entry;
...
// /publish: persist an author-published PREMIUM (royalty-bearing) verified skill — a verified
// skill row plus the author, royalty %, price, and the license/verified token ids.
